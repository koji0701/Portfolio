...
export const CardBody = ({
    ...
    return (
      <div
        className={cn(
          "h-48 w-48 [transform-style:preserve-3d] [&>*]:[transform-style:preserve-3d]",
          className
        )}
      >
        {children}
...
export function Card3D({title, description, image, link}: {
  title: string;
  description: string;
  image?: string;
  link?: string;
      ...
      <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[20rem] h-auto rounded-xl p-4 border">
        ...
        <div className="flex justify-between items-center mt-12">
          <CardItem
            ...
            as="a"
            href={link}
            className="px-3 py-1.5 rounded-xl text-xs font-normal dark:text-white hover:text-neutral-300 transition-colors"
          >
            Learn More →
          </CardItem>
        </div>
